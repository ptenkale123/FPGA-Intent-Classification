...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../chatbot_soc.sopcinfo
...
# Design Name 
# setting SOPC_NAME is chatbot_soc
SOPC_NAME := chatbot_soc
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1607718548
SOPC_SYSID_FLAG += --timestamp=1607718548
ELF_PATCH_FLAG  += --timestamp 1607718548
